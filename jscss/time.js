function showTime() { 
	...
	var startDate = new Date(2018, 10, 06);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear Min:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----Aaron_Kitty 2020/2/14</c>"; 
